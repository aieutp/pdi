...
pageId <- "page_pdi_general"   # <<=== IMPORTANTE! Este id es usado en sideBarMenu
...
templatePDI_General <- div(  # <<=== IMPORTANTE! Esta es la variable que se debe importar desde ui.R
  ...
  div(class="section",
      div("data-aos"="fade-up", "data-aos-once"="false",
          ...
          h3(class="mb-4", "Resultados generales del PDI"),
          fluidRow(
            column(HTML("</br>"), width = 12),
            valueBoxOutput('valuebox_resultado_nivel_pilares_general', width = 4),
            valueBoxOutput('valuebox_resultado_nivel_programas_general', width = 4),
            valueBoxOutput('valuebox_resultado_nivel_proyectos_general', width = 4),
          ),

          h3(class="mb-4", "Resultados tres niveles"),
          fluidRow(
          ...
          #   column(withSpinner(dataTableOutput('tabla_pilares_impulsores'), type=8, color="#036085", size=0.5), width = 12),
              column(withSpinner(dataTableOutput('tabla_tres_niveles_general'), type=8, color="#036085", size=0.5), width = 12),
          ),
          ...
          #   column(withSpinner(htmlOutput('texto_Programas'), type=8, color="#036085", size=0.5), width = 12),
             column(withSpinner(dataTableOutput('tabla_pilares_programas_general'), type=8, color="#036085", size=0.5), width = 12),
          ),
          ...
          fluidRow(
            ...
            column(withSpinner(echarts4rOutput('relacion_eficiencia_general'), type=8, color="#036085", size=0.5), width = 4),
            column(withSpinner(echarts4rOutput('relacion_eficacia_general'), type=8, color="#036085", size=0.5), width = 4),
            column(withSpinner(echarts4rOutput('relacion_efectividad_general'), type=8, color="#036085", size=0.5), width = 4),
            column(withSpinner(dataTableOutput('tabla_proyectos_general'), type=8, color="#036085", size=0.5), width = 12),
          ),
